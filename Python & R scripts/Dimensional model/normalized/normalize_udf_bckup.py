...
normalize_data("count","hou_bedrooms") 
normalize_data("count","hou_rent_percent_income") 
normalize_data("count","hou_rent_rooms") 
normalize_data("count","hou_rent_type_bracket") 
normalize_data("count","hou_rooms") 
#normalize_data("count","hou_status") 
normalize_data("count","hou_status_vacant") 
normalize_data("count","hou_units_structure") 
normalize_data("count","hou_value") 
#normalize_data("count","hou_year_built") 
